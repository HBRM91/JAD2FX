...
// ─── Navigation ───────────────────────────────────────────────────────────────
export type ViewState = 'HOME' | 'DASHBOARD' | 'ANALYSIS' | 'FIXING' | 'BILLETS' | 'COMMODITIES' | 'FORWARDS' | 'SWAPS' | 'LIVE' | 'ADMIN' | 'ABOUT' | 'REPORT' | 'REGULATIONS' | 'BANDS' | 'RESOURCES' | 'CONTACT' | 'RESEARCH' | 'ABOUT_JAD2' | 'TOOL_OC_ASSESS' | 'TOOL_CORRIDOR' | 'TOOL_INVOICE' | 'TOOL_FWD_EXT' | 'SECTOR_AUTO' | 'SECTOR_TEXTILE' | 'SECTOR_NORDIQUE' | 'SECTOR_AGRI' | 'SECTOR_PHOSPHATE' | 'PARITY_MATRIX' | 'TOOL_PME_DIAG' | 'TOOL_IMPORT_COST' | 'TOOL_QUARTERLY' | 'GLOSSARY' | 'BLOG' | 'API_DOCS' | 'PRESS' | 'CHANGELOG' | 'BASKET' | 'QUARTERLY_OUTLOOK' | 'PODCAST' | 'PARTNERSHIPS' | 'CITED' | 'SERVICES' | 'AUDIT_LANDING' | 'SECTOR_CASES' | 'TESTIMONIALS' | 'SENT' | 'TEAM' | 'LEADS' | 'ABOUT_NEW' | 'VOL_SURFACE' | 'MONEY_MARKET' | 'SOVEREIGN' | 'BANK_RATES' | 'CORRELATION' | 'MULTIPANE' | 'ONBOARDING' | 'GLOBAL_SEARCH' | 'MOBILE_SHELL' | 'LIGHT_MODE' | 'AUDIT_LOG' | 'COCKPIT' | 'NOT_FOUND';
