...
Terminer obligatoirement par: "âš ï¸ Données indicatives uniquement â€” pas de conseil en investissement (Loi n° 43-12 / Dahir n° 1-13-21). Conseil: jad2advisory.com"`,
  ...
  const corpWatchpoints = [
    ...
    },
    {
      ...
      body: `AED/MAD ${(0.272294 * usdMad).toFixed(4)} â€” SAR/MAD ${(0.266667 * usdMad).toFixed(4)}. Facturation Gulf en AED ou SAR expose à la variation USD/MAD (pégs stables mais MAD peut varier). Instruments de couverture disponibles via intermédiaires agréés BAM.`,
    },
    {
