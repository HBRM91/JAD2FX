    ...
    <div className={`space-y-5 ${isRTL ? 'text-right' : ''}`} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="px-5 py-2 border-t border-navy-800 flex flex-wrap items-center gap-3">
          ...
          {officialCount === 0 && !loading && (
            <span className="text-[9px] font-mono px-2 py-0.5 rounded border border-amber-700/40 bg-amber-950/20 text-amber-400">
              ⚠ {locale === 'ar' ? 'بيانات BKAM غير متاحة — تحقق من إعداد الوكيل' :
      ...
      <div className="flex items-start gap-3 bg-amber-950/15 border border-amber-800/30 rounded-xl px-4 py-3">
        ...
        <p className="text-[11px] text-amber-300/90 leading-relaxed">
          {locale === 'ar'
            ? 'الأسعار أدناه هي الأسعار الرسمية التي تنشرها يومياً بنك المغرب. تُطبِّق البنوك التجارية المعتمدة هوامشها الخاصة على هذه الأسعار. للحصول على السعر المطبَّق فعلياً على عمليتك، تواصل مع بنكك المعتمد لدى بنك المغرب.'
            : locale === 'en'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-[11px]">
          {[
            ...
            },
            {
              ...
              body: locale === 'ar'
                ? 'تُطبِّق البنوك التجارية المعتمدة من بنك المغرب هوامشها الخاصة فوق هذه الأسعار الرسمية. للاطلاع على السعر الفعلي المطبَّق، تواصل مباشرة مع بنكك.'
                : locale === 'en'
            ...
            },
            {
              ...
              body: locale === 'ar'
                ? 'أسعار الأوراق النقدية أقل ملاءمةً عموماً من أسعار التحويلات بسبب تكاليف المناولة المادية (نقل الأموال، التأمين، التخزين الآمن، العد). هذا الفارق هيكلي في النظام المصرفي.'
                : locale === 'en'
